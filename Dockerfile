...
mirror = "https://stat.ethz.ch/CRAN/" # Use ETH (near to Andreas and me);\
...
install_version("dplyr", version = "0.7.2", repos = mirror);\
install_version("dbplyr", version = "1.1.0", repos = mirror);\
